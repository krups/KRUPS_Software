...
bool Adafruit_L3GD20_Unified::begin(gyroRange_t rng)
{
  ...
  uint8_t id = read8((byte) L3GD20_ADDRESS, GYRO_REGISTER_WHO_AM_I);
  ...
  write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG1, 0x00);
  write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG1, 0x0F);
  /* ------------------------------------------------------------------ */
  ...
  switch(_range)
  {
    case GYRO_RANGE_250DPS:
      write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG4, 0x00);
      break;
    case GYRO_RANGE_500DPS:
      write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG4, 0x10);
      break;
    case GYRO_RANGE_2000DPS:
      write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG4, 0x20);
      break;
  }
  /* ------------------------------------------------------------------ */
           ...
           (event->gyro.z >= 32760) | (event->gyro.z <= -32760) )
      {
        ...
        switch(_range)
        {
          case GYRO_RANGE_500DPS:
            ...
            write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG1, 0x0F);
            write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG4, 0x20);
            write8((byte) L3GD20_ADDRESS, GYRO_REGISTER_CTRL_REG5, 0x80);
            readingValid = false;
